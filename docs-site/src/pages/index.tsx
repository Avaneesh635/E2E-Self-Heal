            ...
            <div className={styles.featuresGrid}>
                <div className={styles.featureCard}>
                    ...
                    <p className={styles.featureText}>
                        Maps the failing selector to the actual DOM change in
                        your <code>git diff</code> — pinpointing the root cause
                        instead of guessing at raw logs.
                    </p>
                </div>
                <div className={styles.featureCard}>
                    <Heading as="h3" className={styles.featureTitle}>
                    ...
                    <p className={styles.featureText}>
                        Only failing locators and wait conditions get rewritten.
                        Assertions and test logic are off-limits — enforced at
                        both the prompt and JSON schema level.
                    </p>
                </div>
                <div className={styles.featureCard}>
                    <Heading as="h3" className={styles.featureTitle}>
                    ...
                    <p className={styles.featureText}>
                        Every patch is re-run with{" "}
                        <code>npx playwright test</code> and loops until the
                        test is green — capped at 3 tries, no runaway fixes.
                    </p>
                </div>
                <div className={styles.featureCard}>
                    <Heading as="h3" className={styles.featureTitle}>
                    ...
                    <p className={styles.featureText}>
                        The same command you run locally powers the GitHub
                        Action. Outcome is signaled via exit codes, so CI can
                        open a patch PR automatically.
                    </p>
                </div>
            </div>
        </section>
                    ...
                    <div className={styles.contentContainer}>
                        <div className={styles.sectionHeader}>
                            ...
                            <p className={styles.sectionSubtitle}>
                                Want to help build self-healing test tools?
                                Choose a component area below to find open
                                GitHub issues.
                            </p>
                        </div>
                        <HelpWantedBoard />
